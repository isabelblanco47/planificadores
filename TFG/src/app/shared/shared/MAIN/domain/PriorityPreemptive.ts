...
export class PriorityPreemptive implements SchedulingAlgorithm {
  ...
  static sortByPriority(a : TaskControlBlock, b : TaskControlBlock) : number {
  ...
  startTask(task: TaskControlBlock): void {
    ...
    if (this.next_state.running_task === null) {
    ...
    } else if (this.next_state.running_task.priority < task.priority) {
        
      this.next_state.running_task.state = TaskState.READY;
      this.ready_task_queue.insertSorted(this.next_state.running_task, PriorityPreemptive.sortByPriority);
      ...
      this.ready_task_queue.insertSorted(task, PriorityPreemptive.sortByPriority);
  ...
  yieldHardDisk(): void {
    ...
    if (this.getHardDiskTask() === null) {
      ...
      this.hard_disk_waiting_queue.insertSorted(running_task, PriorityPreemptive.sortByPriority);
    }
  ...
  ioHardDiskIRQ(): void {
    ...
    if (this.next_state.running_task === null) {
    ...
    } else if (this.next_state.running_task.priority < hard_disk_task.priority) {
      ...
      this.ready_task_queue.insertSorted(hard_disk_task, PriorityPreemptive.sortByPriority);
  ...
  yieldKeyboard(): void {
    ...
    if (this.getKeyboardTask() === null) {
      ...
      this.keyboard_waiting_queue.insertSorted(running_task, PriorityPreemptive.sortByPriority);
    }
  ...
  ioKeyboardIRQ(): void {
    ...
    if (this.next_state.running_task === null) {
    ...
    } else if (this.next_state.running_task.priority < keyboard_task.priority) {
      ...
      this.ready_task_queue.insertSorted(keyboard_task, PriorityPreemptive.sortByPriority);
